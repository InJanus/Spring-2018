...
int getFactor(string temp){
    int myreturn = 0;
    for(unsigned int i = 0; i < temp.size();i++){
        myreturn = myreturn + temp.at(i);
        cout << (int)temp.at(i) << endl;
    }
    cout << myreturn << endl;
    return ((myreturn % 23)+3);
}
void encodeMenu(){
    int input;
    string factor;
    ...
    do{
        ...
        switch(input){
            case 1:{
                ...
                cin.ignore();
                getline(cin,mesage);
                cout << "Factor (Letter Format): ";
                //cin.ignore();
                getline(cin,factor);
                factornum = getFactor(factor);
                //cout << factornum << endl;
                cout << endl;
                string encodeMesage = Encode(mesage,factornum);
            ...
            case 2:{
                ...
                string encodeMesage = Encode(read,factornum);
    ...
    do{
        ...
        switch(input){
            case 1:{
                ...
                factornum = getFactor(factor);
                cout << endl;
                string encodeMesage = Decode(mesage,factornum);
            ...
            case 2:{
                ...
                cout << endl;
                cout << "Mesage: " << read << endl;
                string decodeMesage = Decode(read,factornum);
